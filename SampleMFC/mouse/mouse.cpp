...
// mouse.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CmouseApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CmouseApp::OnAppAbout)
...
CmouseApp::CmouseApp()
{
	...
	SetAppID(_T("mouse.AppID.NoVersion"));

	// TODO: この位置に構築用コードを追加してください。
	// ここに InitInstance 中の重要な初期化処理をすべて記述してください。
}

// 唯一の CmouseApp オブジェクトです。

...
//縮小版のサポート
void CmouseDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 検索ハンドラーのサポート
void CmouseDoc::InitializeSearchContent()
{
...
void CmouseDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
